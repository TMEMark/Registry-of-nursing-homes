...
(4, 'Marija', 'Milošević', 'mmilosevic', '12345', 1),
(5, 'Marko', 'Buljan', 'mbuljan', '12345', 1);
...
(1, 'pokretne starije osobe'),
(2, 'polupokretne starije osobe'),
(3, 'nepokretne starije osobe'),
(4, 'starije osobe s neurološkim bolestima'),
(5, 'starije osobe koje boluju od psihičkih bolesti'),
(6, 'Palijativna skrb'),
...
(10, 'Pomoć u kući'),
(11, 'Boravak'),
(12, 'Smještaj za pokretne korisnike/ce oboljele od raznih demencija'),
(13, 'Smještaj za nepokretne korisnike/ce oboljele od raznih demencija');
...
(8, 'Privremeni smještaj'),
(9, 'Dugotrajni smještaj'),
