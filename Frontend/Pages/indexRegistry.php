      ...
      <div class="gridDescNursingHomes" id="resultContainer">
        <div>
          ...
          if ($_SERVER['REQUEST_METHOD'] === 'GET') {
            $endpoint = 'http://localhost/Registry-of-nursing-homes/Backend/rest/controller/DynamicSearchController.php' . '?' . $_SERVER['QUERY_STRING'];
...
<div class="gridDescNursingHomesMobile">
  ...
  <div class="mainInfo">
    <?php
    $fetchUrl = 'http://localhost/Registry-of-nursing-homes/Backend/rest/controller/ServiceProviderController.php';
