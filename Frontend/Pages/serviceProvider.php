...
<body>
  ...
  <?php
  $rest_api_url = 'http://localhost/Registry-of-nursing-homes/Backend/rest/controller/ServiceProviderController.php';
...
<script>
  function deleteServiceProvider(id) {
    const url = 'http://localhost/Registry-of-nursing-homes/Backend/rest/controller/ServiceProviderController.php?id=<?php echo $serviceProvider_data->service_provider_id ?>';
